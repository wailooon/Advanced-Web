...
<!--
<nav id="accNavbar" class="navbar navbar-default navbar-fixed-top">
    <ul id="#accNavbar" class="nav navbar-nav navbar-right ">    
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right ">
        ...
        <li><a href="#band">LOCATION</a></li>
        <li><a href="#tour">ABOUT US</a></li>
        <li><a href="#contact">CONTACT US</a></li>
        <li><button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#mySearchModal">Search</button></li>
    ...
    <ul id="loginDropdown" class="dropdown-menu">
        <li><a data-toggle="modal" data-target="#myLoginModal">LOGIN <span class="glyphicon glyphicon-new-window"></span></a></li>
        <li><a data-toggle="modal" data-target="#myRegisterModal">REGISTER <span class="glyphicon glyphicon-new-window"></span></a></li>
        <li><a href=" ">&#9829 FAVORITE LIST</a></li>
    </ul>
      </ul>
    </div>
  </div>
